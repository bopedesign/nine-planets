        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              Schedule a <span style={{ fontStyle: 'italic', fontWeight: 300 }}>free</span> consultation.
            </h2>
            <p style={{ fontSize: 16, lineHeight: 1.65, color: 'var(--muted-light)', margin: 0, maxWidth: 440 }}>
              Choose a time and we'll give you a call to discuss your project — goals, scope, timeline, budget. No pitch deck, no pressure.
            </p>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, alignItems: 'stretch' }}>
            <a href="#" className="btn btn-primary" style={{ justifyContent: 'space-between', padding: '18px 22px' }}>
              <span>Schedule a consultation</span>
              <span className="arrow">→</span>
            </a>
            <a href="#" className="btn btn-outline" style={{ justifyContent: 'space-between', padding: '18px 22px' }}>
          ...
          {reviews.map((r, i) => (
            <figure key={i} style={{
              ...
              <div style={{ display: 'flex', gap: 3 }}>
                {[0,1,2,3,4].map(j => <Star key={j} size={12} />)}
              </div>
              <blockquote style={{
                margin: 0,
                fontSize: 16,
